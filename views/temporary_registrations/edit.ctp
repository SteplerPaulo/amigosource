...
<?php echo $this->Form->create('TemporaryRegistration');?>
	<fieldset>
		<legend><?php __('Edit Temporary Registration'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('TemporaryRegistration.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('TemporaryRegistration.id'))); ?></li>
