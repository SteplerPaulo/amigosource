<!--REFERENCE: http://bakery.cakephp.org/articles/toxic_brain/2010/06/26/breadcrumb-helper-->
...
var $separator    = '<i class="glyphicon glyphicon-arrow-right"></i>'            ;    // separator between links. 
var $protocol    = 'http'            ; 
