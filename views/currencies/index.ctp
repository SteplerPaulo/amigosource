<div class="currencies index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('is_dd');?></th>
			<th><?php echo $this->Paginator->sort('seq_no');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $currency['Currency']['is_dd']; ?>&nbsp;</td>
		<td><?php echo $currency['Currency']['seq_no']; ?>&nbsp;</td>
