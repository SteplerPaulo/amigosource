<div class="row TmpRegElement" id="user-account">
	<div class="col-lg-4 col-lg-offset-4">
		<?php echo $this->Form->input('email',array('class'=>'form-control input-sm required','placeholder'=>'*Required'));?>
		<?php echo $this->Form->input('password',array('id'=>'Password','type'=>'password','class'=>'form-control input-sm required','placeholder'=>'*Required'));?>
		<?php echo $this->Form->input('confirm_password',array('id'=>'ConfirmPassword','type'=>'password','class'=>'form-control input-sm required','placeholder'=>'*Required'));?><br/>
