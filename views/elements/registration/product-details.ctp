		...
		<div class="panel-body">
			<div class="row">
				<div class="col-lg-6" id="AddProductForm">
					...
					<div class="row">
						<div class="col-lg-6">
							<?php echo $this->Form->input('Pr.contact_name',array('field'=>'contact_name','class'=>'form-control input-sm','div'=>false))?>			
						</div>
						<div class="col-lg-6">
						...
						<tbody>
							<tr style="display:none">
								...
								<td class="hide">
									...
									<?php echo $this->Form->input('TemporaryRegistrationProduct.monetary_currency_id',array('field'=>'monetary_currency_id','type'=>'hidden','label'=>false,'class'=>'form-control'));?>
									...
									<?php echo $this->Form->input('TemporaryRegistrationProduct.contact_name',array('field'=>'contact_name','type'=>'hidden','label'=>false,'class'=>'form-control'));?>
